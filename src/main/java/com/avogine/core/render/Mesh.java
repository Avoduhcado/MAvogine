...
public class Mesh {
	...
	/**
	 * Generate and load a new <tt>Vertex Buffer Object</tt> into this mesh's <tt>Vertex Array Object</tt>.
	 * @param location The index this VBO should occupy in the mesh's VAO
	 * @param data The actual vertex data to load
	 * @param size How many values are associated per vertex, <tt>data / size</tt> should return a whole number
	 */
	public void addAttribute(int location, FloatBuffer data, int size) {
		...
		if (vboMap.containsKey(location)) {
			System.out.println("Overwriting location: " + location);
		}
	...
	/**
	 * <p>Generate and load a new <tt>Vertex Buffer Object</tt> into this mesh's <tt>Vertex Array Object</tt>.
	 * 
	 * <p>This method will allocate and free a new {@link FloatBuffer} as directly loading float arrays is unpreferred when loading buffer data. 
	 * @param location The index this VBO should occupy in the mesh's VAO
	 * @param data The actual vertex data to load
	 * @param size How many values are associated per vertex, <tt>data / size</tt> should return a whole number
	 */
