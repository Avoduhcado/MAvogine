package com.avogine.render.util.stb;
...
public class ImageLoader {
	 ...
	 * @return an {@link ImageSTB} containing image data of the loaded file and the contained pixels buffer.
	 */
	public static ImageSTB loadImageSTB(String imagePath, boolean flipVerticallyOnLoad) {
		try (MemoryStack stack = MemoryStack.stackPush()) {
			...
			return new ImageSTB(width, height, format, imageBuffer);
		}
	}
	 ...
	 * @return an {@link ImageSTB} containing image data of the loaded file and the contained pixels buffer.
	 */
	public static ImageSTB loadImageSTB(String imagePath) {
