...
public class AvoNuklear {
	...
	// The identifier of the GLFW window
	private long win;
	
	// The pixel dimensions of the GLFW window
	private int width = 1920;
	private int height = 1080;
	
	// The pixel dimensions of the content inside the window, this will usually be the same size as the window.
	...
	public void init(Window window) {
		initInputForGLFWWindow(window.getId());
		initFont();
	}
	
	/**
	 * TODO Figure out why this is supposed to return the context
	 * @param windowID
	 * @return
	 */
	private NkContext initInputForGLFWWindow(long windowID) {
		...
		glfwSetCharCallback(windowID, (window, codepoint) -> nk_input_unicode(context, codepoint));
